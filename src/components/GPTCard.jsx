...
export default function GPTCard({ property, i }) {
  ...
  return (
    <>
      <div className="md:block hidden transform ease-in w-full bg-white bg-opacity-50 hover:bg-opacity-100 rounded-md border p-4 text-left">
        <div className="flex items-center text-left justify-between">
          <div className="flex items-center gap-1">
            <img
              className="w-20 h-20 rounded-full mr-4 bg-cover"
            ...
            <div>
              ...
              <p className="text-sm pt-1 pb-1">Tagline</p>
      ...
      <div className="md:hidden block transform ease-in w-full bg-white bg-opacity-50 hover:bg-opacity-100 rounded-md border p-4 text-left">
        <div className="flex items-center text-left justify-between">
          <div className="flex items-center gap-1">
            ...
            <div>
              ...
              <p className="text-sm pt-1 pb-2">Tagline</p>
        ...
        <div className="flex gap-4 mt-6">
          <Link
            to={`/gpts/${property.url}`}
            className="cursor-pointer px-3 py-1.5 border-2  hover:border-green font-medium rounded-md text-gray-900 bg-gray-100 text-lg transform ease-in duration-100 group"
          >
            Visit
          </Link>
